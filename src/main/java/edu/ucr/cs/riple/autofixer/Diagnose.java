...
public class Diagnose {
  ...
  public CallContext callGraph;
  public FieldContext fieldGraph;
  ...
  private void init(String buildCommand) {
    ...
    this.callGraph = new CallContext(out_dir + "/call_graph.csv");
    this.fieldGraph = new FieldContext(out_dir + "/field_graph.csv");
